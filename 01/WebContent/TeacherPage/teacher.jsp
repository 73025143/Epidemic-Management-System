    ...
    <style>
        ...
        *:after {
        ...
        body {
            ...
            background: #ededed;
			background:url("../Imagin/loginTeacher.jpg");
...
<body>
    <div id="app">
        ...
        <div>
            ...
            <div class="content">
            	<form action="doTeacherLogin.jsp" method="post" name="teacherLoginForm">
                <div class="form sign-in">
                    <h1>Welcome Back</h1>
                    <label>
                        <span>TEACHER ID</span>
                        <input  name="teacherID" id="teacherID"/>
                    </label>
                    <label>
                        <span>PASSWORD</span>
                        <input type="password" name="password" id="passwordLogin"/>
                    </label>
                    <button type="button" onclick="document.teacherLoginForm.submit();" class="submit">Log In !</button>
                ...
                <div class="sub-cont">
                    <div class="img">
 					...
 					<form action="doTeacherRegist.jsp" method="post" name="teacherRegistForm" id="teacherRegistForm">
                    <div class="form sign-up">
                        <h1>Register Immediately</h1>
                        <label style="position:relative;top:-30px;left:-160px">
                            <span>Teacher ID <input type="text" /name="teacherID" id="teacherIDRegist" onblur="checkregistID()" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"></span>
                        </label>
                        ...
                        <label style="position:relative;top:-190px;left:-160px">
                          ...
                          onafterpaste="this.value=this.value.replace(/\D/g,'')" name="age" id="age" onblur="checkRegistGrade()"/>
                        </label>
    ...
    <script>
        ...
        new Ctor().$mount("#app")
            ...
            var form2 = document.getElementById('teacherRegistForm');
            function q2(){
            ...
            function checkRegistGrade(){
            	var tele = document.getElementById("age").value;
            	if (tele == "") {
                    alert("Please enter your age");
        			return false;
                }else if(tele<0 ||tele!=2&&tele>150){
            ...
            function checkregistID(){
            	var tele = document.getElementById("teacherIDRegist").value;
            	if (tele.length!=4) {
                    alert("Please enter your 4 bit ID");
        			return false;
                }else{
        			return true;
        		}
